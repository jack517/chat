...
window.onload = function () {
	var chart = new CanvasJS.Chart("chartContainer", {
		theme: "theme2",//theme1
		title:{
			text: "Statisitical Review of $hosp"
		},
    axisY:{
   //     minimum: 50,
      maximum: 100
		...
		data: [
		{
			...
			type: "column",
			dataPoints: [
				{ label: "Doctor",  y: $doctor  },
				{ label: "Medicine", y: $medicine  },
				{ label: "Facilities", y: $facilities  },
				{ label: "Management",  y: $management  },
				{ label: "Cleanliness",  y: $clean  },
        { label: "Overall Satisfaction",  y: $overall }
			]
		}
		]
	});
   ...
   //     minimum: 50,
      ...
      click: onClick,
			dataPoints: [
				...
				{ label: "Facilities", y: $facilities  },
				{ label: "Management",  y: $management  },
				{ label: "Cleanliness",  y: $clean ,link:"clean.php" },
        { label: "Overall Satisfaction",  y: $overall }
			]
		}
		]
